...
public:
  ...
  VescInterface(
    float wheel_diameter, float motor_ratio, float max_steer_angle, float servo_min,
    float servo_max, float motor_max_rpm);
  double get_speed(double & speed_val);
  double get_stearing_angle(double & stearing_val);
